      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6 pb-6 sm:pb-8">
          ...
          <a href="<?php echo esc_url($all_news_url); ?>" 
             class="view-all-news-btn inline-flex items-center justify-center gap-2 sm:gap-2.5 self-center sm:self-auto text-sm sm:text-base transition-all duration-300"
            ...
            <span class="view-all-news-arrow inline-flex items-center">
              <svg class="default-arrow sm:w-5 sm:h-5" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 21 21" fill="none">
                  ...
                  <a href="<?php echo get_permalink($post_id); ?>" 
                    ...
                    <span class="read-more-arrow inline-flex items-center justify-center">
                      <svg class="read-more-arrow-default w-5 h-5 transition-transform duration-300 group-hover:translate-x-1" xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none">
                        <path d="M11.5246 10.4999L7.19336 6.16861L8.43148 4.93136L14 10.4999L8.43149 16.0684L7.19424 14.8311L11.5246 10.4999Z" fill="#000000"/>
                      </svg>
                      <svg class="read-more-arrow-hover w-5 h-5 transition-transform duration-300 group-hover:translate-x-1" xmlns="http://www.w3.org/2000/svg" width="17" height="11" viewBox="0 0 17 11" fill="none">
